...
export default function HeartIcon({ className }) {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M12 21s-7.5-4.6-10-8.7C-0.5 8.1 2.4 3 6.9 3c2.2 0 3.7 1.3 5.1 2.9C13.4 4.3 14.9 3 17.1 3 21.6 3 24.5 8.1 22 12.3 19.5 16.4 12 21 12 21z" />
    </svg>
  );
}
